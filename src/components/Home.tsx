...
const Home = () => {
  return (
    <div id="Home" className="flex flex-col-reverse md:flex-row justify-center 
    items-center md:my-32 my-10">
       ...
       <div className="flex flex-col "> 
            ...
            mt-10 md:mt-0">
               Bonjour 👋, <br /> je suis{""} 
               <span 
               className="text-accent"> GodsonDev</span> 
            </h1>
            <p className="my-4 text-md text-center
            md:text-left">
                Je suis un développeur full-stack <br /> 
                avec 2 ans d'expérience, utilisant React <br /> et Node.js.
       ...
       <div className="md:ml-60">
            ...
            style={{
                borderRadius: "33% 70% 70% 30% / 67% 62% 38% 33%"
            }}
            />
