...
const experiences = [
    {
        ...
        description: [
            "Développement de nouvelles fonctionalités pour Google Maps.",
            "Optimisation des performences de l'application.",
        ],
        image: google,
    },
    {
        ...
        compagny: "Meta",
        period: "Jan 2021 - Aôut 2022",
        description: [
            "Création d'une plateforme interne de collaboration pour les equipes.",
...

    {
        ...
        description: [
            "Développement d'une interfaces utilisateur pour Amazon web Services.",
  ...
  return (
    <div id="Experiences">
        ...
        items-center">
            ...
            items-center md:w-1/3 mt-4 md:mt-0">
                {skills.map((skill) => (
                        ...
                        <div className="flex items-center">
                            <img    
                                    ...
                                    <div className="ml-4">
                                        ...
                                        <span className="text-sm">{experience.
                                        period}</span>
                                    </div>
                        </div>
